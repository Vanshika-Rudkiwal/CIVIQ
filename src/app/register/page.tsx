    ...
    <main id="main-content" className="min-h-screen bg-[#fffde7] flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-[#1a1a3a]">Create your account</h1>
          <p className="text-gray-500 mt-1">Find the schemes you qualify for</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/login" className="text-[#2d52c8] font-semibold hover:underline">
              Log in
            </Link>
          </p>
        </div>
